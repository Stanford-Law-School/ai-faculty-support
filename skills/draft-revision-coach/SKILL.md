...
description: Help faculty revise the structure and argument flow of a substantial scholarly draft while preserving authorship and meaning. Use when the user provides an article, chapter, section, abstract, or outline and needs diagnosis of organization, section purpose, claim sequence, repetition, transitions, evidence placement, counterargument treatment, reader burden, or a prioritized revision plan. Read the supplied draft before advising. Do not fabricate missing sources, silently rewrite the entire manuscript, or focus on sentence-level style when structural revision is the primary need.
---
