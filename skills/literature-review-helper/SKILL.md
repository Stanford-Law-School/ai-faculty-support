...
description: Help faculty plan and conduct a transparent literature or source review using supplied materials and current research. Use when the user needs search concepts, database selection, inclusion and exclusion criteria, a source matrix, thematic synthesis, disagreement mapping, chronology, gap verification, or an annotated review plan across legal, interdisciplinary, policy, historical, or empirical scholarship. Require actual source retrieval and reading before substantive claims. Do not fabricate citations, claim comprehensive coverage without a documented method, or treat AI summaries as a literature review.
---

# Literature Review Helper

**Map the conversation before claiming a contribution.**
