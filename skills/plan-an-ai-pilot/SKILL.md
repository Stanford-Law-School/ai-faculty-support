...
Do not activate for initial problem framing (route to the Problem-Based Approach to AI), a small single-behavior demonstration (route to the Test What AI Can Do), procurement approval, security certification, deployment, or definitive legal review.
...
- Problem still unclear, or whether AI belongs at all → Problem-Based Approach to AI.
- Single behavior or failure mode to test directly → Test What AI Can Do.
- What a current product is and what it adds → Understand an AI Tool.
- Whether a claim is supported by evidence → Check an AI Claim.
- Authority, responsibility, and stopping power → Test AI Governance.
- Course integration of what was learned → SLS teaching Skills and the Bring AI Into Your Teaching.

All eight Judgment Series destinations are implemented; describe any genuinely future collections (such as the planned Research and Scholarship collection) as planned rather than available.
