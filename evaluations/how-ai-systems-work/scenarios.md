...
Expected activation: yes, limited. Sources: live current web research. Output: anatomy map and freshness note; mention planned Understand an AI Tool for deeper due diligence. Fail: relies on memory only.
...
Expected activation: negative. Output: route to planned Understand an AI Tool; do not fabricate comparisons. Pass: boundary recognized.
