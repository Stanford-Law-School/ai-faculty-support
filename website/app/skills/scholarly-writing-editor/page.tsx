...
export default function ScholarlyWritingEditorSkill() {
  const skill = getSkill("scholarly-writing-editor");
  return (
    <>
      <SkillBreadcrumb slug="scholarly-writing-editor" />
      <p className="eyebrow">Faculty Research &amp; Scholarship &middot; {skill.status} &middot; v{skill.version}</p>
      <h1>{skill.name}</h1>
      <p className="lede">Sharpen the prose without letting anyone rewrite your argument.</p>
      ...
      <section className="grid two">
        <article className="card">
          <h2>What it does</h2>
          <p>It edits for clarity, precision, concision, paragraph coherence, transitions, tone, terminology, and consistent voice at a level of intervention you agree to in advance &mdash; and surfaces substantive uncertainty instead of smoothing it away or silently changing legal meaning.</p>
        </article>
        <article className="card">
